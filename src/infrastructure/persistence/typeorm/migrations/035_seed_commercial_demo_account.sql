...
-- Crea la empresa y usuario de demostración comercial SOLO si no existen (Zero-Mutation safe)

DO $$
DECLARE
    v_tenant_id UUID := 'f0eebc99-9c0b-4ef8-bb6d-6bb9bd380d01';
    v_user_id UUID := 'f0eebc99-9c0b-4ef8-bb6d-6bb9bd380d02';
    v_password_hash VARCHAR := '$2b$10$pt.sLuZj5OofdJCIz.RjsuHbVx9bJogiwfCgzbWl7VwolnQxwpHm2';
BEGIN
    -- 1. Insertar Tenant Demo SOLO si no existe
    ...
    -- 2. Insertar Usuario Demo SOLO si no existe
